    ...
    private function getAuditData($kitchenId, $date)
    {
        ...
        foreach ($dailyMenus as $menu) {
            ...
            if (!in_array($masterMenuId, $processedMenus)) {
                $smallItems = [];
                $largeItems = [];
                $smallNutri = ['kcal' => 0, 'protein' => 0, 'fat' => 0, 'carbs' => 0, 'fiber' => 0];
                $largeNutri = ['kcal' => 0, 'protein' => 0, 'fat' => 0, 'carbs' => 0, 'fiber' => 0];
                ...
                foreach ($menu->items as $item) {
                    ...
                    if ($food) {
                        ...
                        $sFiber = ($item->weight_small / 100) * $food->fiber_g;
                        ...
                        $lFiber = ($item->weight_large / 100) * $food->fiber_g;
