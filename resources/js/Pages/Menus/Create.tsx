        ...
        const calc = (items: MenuItem[], type: 'small' | 'large') => {
            return items.reduce((acc, item) => {
                ...
                return {
                    ...
                    fiber: acc.fiber + ((fi.fiber_g || 0) * ratio),
                };
                                ...
                                <div className="relative z-10 space-y-12">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-3 pt-4 border-t border-white/5">
                                            {[
                                                { label: 'Protein', value: totals.small.protein, target: configSmall?.meal_protein || 10.5, color: 'bg-emerald-500' },
                                                { label: 'Lemak', value: totals.small.fat, target: configSmall?.meal_fat || 16.0, color: 'bg-amber-500' },
                                                { label: 'Karbohidrat', value: totals.small.carbs, target: configSmall?.meal_carbs || 72.0, color: 'bg-blue-500' },
                                                { label: 'Serat ✓', value: totals.small.fiber, target: configSmall?.meal_fiber || 5.0, color: 'bg-teal-400' },
                                            ].map(macro => (
                                                <div key={macro.label} className="space-y-2">
                                                    <div className="flex justify-between text-[9px] font-black uppercase tracking-tighter">
                                                        <span className="text-slate-500">{macro.label}</span>
                                                        <span>{Math.round(macro.value * 10) / 10}g / {macro.target}g</span>
                                                    </div>
                                    ...
                                    <div className="space-y-6 pt-12 border-t border-white/10">
                                        ...
                                        <div className="space-y-3 pt-4 border-t border-white/5">
                                            {[
                                                { label: 'Protein', value: totals.large.protein, target: configLarge?.meal_protein || 18.3, color: 'bg-emerald-500' },
                                                { label: 'Lemak', value: totals.large.fat, target: configLarge?.meal_fat || 21.3, color: 'bg-amber-500' },
                                                { label: 'Karbohidrat', value: totals.large.carbs, target: configLarge?.meal_carbs || 95.3, color: 'bg-blue-500' },
                                                { label: 'Serat ✓', value: totals.large.fiber, target: configLarge?.meal_fiber || 7.0, color: 'bg-teal-400' },
                                            ].map(macro => (
                                                <div key={macro.label} className="space-y-2">
                                                    <div className="flex justify-between text-[9px] font-black uppercase tracking-tighter">
                                                        <span className="text-slate-500">{macro.label}</span>
