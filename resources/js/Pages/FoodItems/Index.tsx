                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-emerald-900/5 bg-slate-50/50">
                                    ...
                                    <th className="px-4 py-6 text-[10px] font-black text-emerald-600/60 uppercase tracking-[0.2em] text-center">SERAT</th>
                                ...
                                {foodItems.data.length > 0 ? (
                                    foodItems.data.map((item) => (
                                        <tr key={item.id} className="group hover:bg-emerald-50/30 transition-all">
                                            ...
                                            <td className="px-4 py-6 text-center font-black text-teal-600 text-sm">{item.fiber_g ?? 0}g</td>
