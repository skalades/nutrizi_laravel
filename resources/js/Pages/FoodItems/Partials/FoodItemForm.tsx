                        ...
                        <div className="bg-slate-900 p-8 rounded-[3rem] shadow-2xl space-y-6 relative overflow-hidden">
                            ...
                            <div className="space-y-4 relative z-10">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[8px] font-black text-emerald-400 uppercase tracking-widest ml-1">Serat (g) ✓</label>
                                        <input 
                                            type="number"
                                            step="0.1"
                                            className="w-full bg-emerald-900/30 border border-emerald-500/20 rounded-xl p-3 text-emerald-300 font-black text-center focus:ring-1 focus:ring-emerald-400 text-sm"
                                            value={data.fiber_g}
                                            onChange={(e) => setData('fiber_g', Number(e.target.value))}
                                        />
                                    </div>
                                </div>
                            </div>
