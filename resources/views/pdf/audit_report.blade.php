...
<body>
    ...
    @if(count($nutritionSummary) > 0)
        ...
        @foreach($nutritionSummary as $nutri)
            ...
            <table class="table" style="margin-bottom: 20px;">
                <thead>
                    <tr>
                        <th width="35%">Komponen Bahan</th>
                        <th width="13%" style="text-align: right;">Energi</th>
                        <th width="13%" style="text-align: right;">Protein</th>
                        <th width="13%" style="text-align: right;">Lemak</th>
                        <th width="13%" style="text-align: right;">Karbo</th>
                        <th width="13%" style="text-align: right;">Serat</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($nutri['small_items'] as $sit)
                        <tr>
                            ...
                            <td style="text-align: right;">{{ number_format($sit['fiber'] ?? 0, 1) }}g</td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr style="background-color: #f1f5f9; font-weight: 800;">
                        ...
                        <td style="text-align: right;">{{ number_format($nutri['small_total']['fiber'] ?? 0, 1) }}g</td>
                    </tr>
                    <tr style="background-color: #f0fdf4; color: #166534; font-size: 8px; font-weight: 700;">
                        <td>Target Standar Gizi (SD) — Juknis MBG</td>
                        ...
                        <td style="text-align: right;">5.0g</td>
                    </tr>
                </tfoot>
            </table>
                ...
                <tbody>
                    @foreach($nutri['large_items'] as $lit)
                        <tr>
                            ...
                            <td style="text-align: right;">{{ number_format($lit['fiber'] ?? 0, 1) }}g</td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr style="background-color: #f1f5f9; font-weight: 800;">
                        ...
                        <td style="text-align: right;">{{ number_format($nutri['large_total']['fiber'] ?? 0, 1) }}g</td>
                    </tr>
                    <tr style="background-color: #f0fdf4; color: #166534; font-size: 8px; font-weight: 700;">
                        <td>Target Standar Gizi (SMP/SMA) — Juknis MBG</td>
    ...
    <div class="signature-area">
        <div class="signature-box">
            <div class="signature-title">{{ $auditLog ? 'Ahli Gizi Penanggung Jawab,' : 'Pengawas Gizi,' }}</div>
